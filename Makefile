...
CURRENT_TEST_MODULES = \
	...
	test_cameraopt_reclaim_port test_camera_video_profiles test_tier2_camera_records test_ims_integration test_tier1_ims_dim_record test_v15_install_record \
