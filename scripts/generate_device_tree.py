...
TEMPLATE_FILES = (
    ...
    "leica-essential.mk",
    "now-playing-dsp-model.mk",
    "now-playing-dsp-model/verify.py",
    "now-playing-dsp-model/contract.json",
    "aicore.mk",
    "aicore/verify.py",
    "aicore/contract.json",
    "ims.mk",
    "ims/Android.bp",
    ...
    "cameraopt-service/compile-stubs/com/miui/cameraopt/configs/JsonDisptcher.java",
    ...
    "workload-classifier.mk",
    "haptics.mk",
    "haptics-overlay/frameworks/base/core/res/res/values/config.xml",
    "haptics-overlay/packages/apps/Settings/res/values/config.xml",
    "dolby.mk",
    "dolby/Android.bp",
    "dolby/AndroidManifest.xml",
    "dolby/README.md",
    "dolby/res/values/strings.xml",
    "dolby/src/org/evolution/nezha/dolby/DolbyProtocol.java",
    "dolby/src/org/evolution/nezha/dolby/DolbyController.java",
    "dolby/src/org/evolution/nezha/dolby/MainActivity.java",
