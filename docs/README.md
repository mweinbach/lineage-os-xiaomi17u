...
| [Native camera session hook](camera-native-hook-20260907.md) | Factory cameraserver call sites and ABI recovered; guarded v8 source uses the library factory, camera-ID registration, session updater and scene-identification hook before HAL configuration; build and device results tracked separately |
