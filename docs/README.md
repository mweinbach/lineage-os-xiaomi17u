...
| [GMS source integration](gms-source-integration.md) | Four-file adoption, ordinary metadata checks, corrected read-only graph capture and proof staging pass; actual GMS module builds, Images2 and package2 remain pending |
