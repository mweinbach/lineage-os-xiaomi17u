...
| [GMS source integration](gms-source-integration.md) | Four-file adoption, config7/context7 and ordinary nothing4 pass on 541 files/fourteen projects; six metadata values are verified, while GMS modules, Images2 and package2 remain pending |
