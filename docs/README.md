...
| [Initial GMS optional-library correction](gms-customization-optional-library.md) | Preserved 0018 customization declaration and package-failure checkpoint; not installed, with the later 95-module audit and four-file proposal recorded separately |
| [Additional GMS optional-library corrections](gms-prebuilt-optional-libraries.md) | Native audit retains 91 passes/four mismatches; 0019 and 0018 form the four-file proposal whose read-only native probe passes, while adoption, ordinary status actions and packaging remain pending |
