...
| [GMS source integration](gms-source-integration.md) | The adopted 543-file source passes config8/context8/nothing5 and six metadata values; fresh read-only observations do not qualify the new graph, rebuilt signer or strict GMS retry; earlier failures remain preserved |
