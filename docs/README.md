...
| [Nothing10 profile failure and historical host-storage hold](build-progress.md#nothing10-profile-failure-and-host-storage-hold--2026-09-02) | Native exit 0 but profile exit 1 after six configuration changes; preserves the earlier below-reserve hold, before the separate host-cleanup checkpoint; Nothing11 remains host-only |
