...
| [Checksum 0023 source and identity](build-progress.md#checksum-0023-source-installation--2026-09-02) | The 548-file/fifteen-project adoption and eight-output host identity replay pass; projected build is `nezha.a7db36604f45fcc657373f89`, while native configuration/metadata and successor component/image/package evidence remain pending |
