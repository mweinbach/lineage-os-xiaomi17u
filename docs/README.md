...
| [Factory camera stream sizing](camera-stream-sizing-20260908.md) | Five-file mock/custom-size source repair and native component build pass; full package in progress, not device-admitted |
