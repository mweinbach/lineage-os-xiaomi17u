...
| [GMS optional-library source correction](gms-customization-optional-library.md) | Retained package failure and one-line host-tested Make declaration; native adoption, the broader strict GMS audit and package completion remain pending |
