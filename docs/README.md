...
| [Tier 1 source work: IMS, dim level, QMI](tier1-ims-dim-20260909.md) | Source revision 13: exact-stock IMS provider with the restored vendor_qtelephony domain built through strict gates, dim level corrected to the framework default, QMI daemon loop diagnosed and deferred to the vendor policy cycle; delivery set v15 pending |
...
| [Camera experiment with root](camera-root-experiment-20260907.md) | Root on the userdebug opt-in; clearing persisted camera state refuted; boot chain matches stock; historical probe interpretation corrected by the library analysis |
...
| [Camera completion progress](camera-completion-20260907.md) | Retained v8 rear/front Ultra HDR and RAW, three physical RAW captures, 20 extension cases and Aperture Bokeh; later installations follow below |
...
| [Xiaomi vendor-key discovery](camera-vendor-key-discovery-20260908.md) | Measured missing shot-name discovery; guarded framework fix installed in v10; ordinary Xiaomi photos now save |
| [CameraX extension cache](camerax-extension-cache-20260908.md) | Diagnosed effect-switch preview mismatch; upstream cache-key backport compiled; real-class JVM, ABI and optimized APK checked; all ten warm rear/front effect captures pass in v10 |
| [Camera v10 package](camera-v10-package-20260908.md) | Combined vendor-key and CameraX fixes; full build, signed archive and eight-image bundle verified; pre-install package checkpoint; subsequent runtime results below |
...
| [Camera save and audio compatibility candidate](camera-save-audio-compat-20260908.md) | Historical source-stage checkpoint for the compressed DNG writer, neutral HDR repair and audio conversions; subsequent v12 delivery and runtime records below |
| [Camera v12 package](camera-v12-package-20260908.md) | Historical build, signing and eight-image verification checkpoint; subsequently installed with the qualified runtime results below |
| [V12 installation and validation](camera-v12-install-validation-20260908.md) | All ten warm effect captures fully decode as Ultra HDR; Xiaomi photos, 200 MP and RAW regressions pass; traced compressed Bayer DNG and vendor audio conversion remain open |
| [Bayer DNG and audio descriptor compatibility](camera-bayer-audio-compat-20260908.md) | Successor source candidate for measured compressed Bayer format 32, multiroute and MIHC; twelve synthetic DNG decodes and complete primary-module conversion checks pass |
| [Camera v13 package](camera-v13-package-20260908.md) | Compressed Bayer DNG and multiroute/MIHC audio package built, signed and verified; subsequent installation recorded below |
| [Wallpaper & style clock plugin crash](wallpaper-clock-plugin-20260908.md) | Measured cause: the stale SystemUIClocks-Flex prebuilt targets the pre-QPR2 plugin interface package; patch 0039 drops its product selection; audit tool, tests, source revision 11 build, signed archive and v14 bundle verified on the host; subsequent installation recorded below |
| [V14 installation and Wallpaper & style validation](wallpaper-v14-install-validation-20260908.md) | Installed on slot A, Enforcing; picker opens from launcher and Settings, eight clock faces offered, plugin clock applied and default restored, no plugin rejection or crash; rear/front photo, UltraRAW, Aperture effect and HEVC/AAC video pass |
| [V13 installation and validation](camera-v13-install-validation-20260908.md) | UltraRAW DNG/preview, audio startup, HEVC/AAC video, photo/RAW regressions and all ten warm CameraX Ultra HDR effects pass |
...
| [Package6 producer tools and kernel BTF](build-progress.md#package6-producer-tools-and-kernel-btf--2026-09-03) | Recipe/RSP, limited static comparison and selected ZIP identity reviews pass; BTF remains ambiguous and the Super wrapper fails, with output recovery, producer/runtime, policy/ABI/trust and ROM gates open |
| [Package6 boot-property reviews and follow-up captures](build-progress.md#package6-boot-property-reviews-and-follow-up-captures--2026-09-03) | Scoped boot/property and static search reviews pass; boot-text metadata and a 68-call producer capture advance, while effective source/provider/runtime, compiled policy/ABI/trust and ROM gates remain open |
| [Package6 protected-export gate and libvintf producer query](build-progress.md#package6-protected-export-gate-and-libvintf-producer-query--2026-09-03) | Bounded kernel capture and local branch observations advance alongside six read-only producer queries; AIDL lexical correction retains the negative, while callback/runtime, policy/ABI/trust and ROM gates remain open |
| [Package6 producer retry and pointed-name reference review](build-progress.md#package6-producer-retry-and-pointed-name-reference-review--2026-09-03) | Corrected capture and source/PYC admission pass; the conditional pointed-name reference lane closes across all 637 payloads, while deeper consumers, provider/policy/ABI/trust, runtime and ROM gates remain separate |
| [Package6 static kernel mapping and pointed-string capture](build-progress.md#package6-static-kernel-mapping-and-pointed-string-capture--2026-09-03) | Conditional saved-byte mapping passes independent review and pointed strings are captured; deeper semantics, compiled policy/ABI/trust and ROM gates remain open, with source-only VINTF publication and an unfinished native retry kept distinct |
| [Package6 conditional stages and kernel relocation capture](build-progress.md#package6-conditional-stages-and-kernel-relocation-capture--2026-09-03) | All current payloads match conditional reference vermagic semantics; normal/recovery stage closures have no findings under stated assumptions, while relocation interpretation, ABI/trust, runtime and ROM gates remain open |
| [Package6 current module union and source-copy origin](build-progress.md#package6-current-module-union-and-source-copy-origin--2026-09-03) | Current providers cover all 718 earlier CRC gaps, with 20 ambiguous/mixed rows unresolved; source/copy origin closes, while ABI/trust, boot-source/runtime, VINTF, super/fit, OTA and boot remain open |
| [Package6 corrected captures and negative AIDL audit](build-progress.md#package6-corrected-captures-and-negative-aidl-audit--2026-09-03) | Corrected query/ramdisk captures and scoped kernel/Mac checks complete; negative metadata coverage and pending ABI/source/runtime interpretation remain distinct from full VINTF, super/fit, OTA or boot success |
| [Package6 independent VINTF inputs and retained ABI gaps](build-progress.md#package6-independent-vintf-inputs-and-retained-abi-gaps--2026-09-03) | Independent 298-member input review passes and a third proof is host-staged; ABI analysis retains 718 unbound expectations, original capture failure remains recorded, and native/runtime, VINTF, super/fit, OTA and boot gates stay open |
| [Package6 DLKM reference-model semantics and loader-text binding](build-progress.md#package6-dlkm-reference-model-semantics-and-loader-text-binding--2026-09-03) | Exact metadata bodies and current init-text bindings pass; conditional selector/dependency results retain optional gaps, with loader execution, ABI/trust, property/VINTF, super/fit, OTA and boot still open |
