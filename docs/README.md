...
| [GMS source integration](gms-source-integration.md) | Native four-module build exits 0, but strict CrossDevice SourceStamp postcheck fails; SignApk correction, verified retry, Images2 and package2 remain pending |
| [SignApk source-stamp correction](signapk-source-stamp.md) | Prepared two-file fix removes obsolete stamp metadata before APK signing and restores the normal signer dependency; native adoption and a strict retry remain pending |
