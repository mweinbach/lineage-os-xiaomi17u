...
| [Wallpaper & style clock plugin crash](wallpaper-clock-plugin-20260908.md) | Measured cause: the stale SystemUIClocks-Flex prebuilt targets the pre-QPR2 plugin interface package; patch 0039 drops its product selection, audit tool and tests added; successor build and device validation recorded below |
