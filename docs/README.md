...
| [SystemUI Clock library correction](systemui-clocks-optional-window-libraries.md) | Selected-nine build and independent 201-file proof replay pass; successor Images3 build and 56-file proof replay verify seven fresh outputs with prior images/sidecars preserved, while Package3 and hardware gates remain pending |
