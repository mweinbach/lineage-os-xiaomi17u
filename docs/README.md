...
| [SystemUI Clock library correction](systemui-clocks-optional-window-libraries.md) | Actual 0022 adoption and config10/context10/Nothing7 pass on 545 sources; the 83-query shared capture qualifies the graph and eight raw Clock payloads are read back, while actual component/status/signature, copied-config and image/package gates remain pending |
