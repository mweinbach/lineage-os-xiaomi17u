...
| [GMS source integration](gms-source-integration.md) | Four-file adoption and full readback pass with 541 source files across fourteen projects; host identity is reprojected, while native queries, ordinary status actions and packaging remain pending |
