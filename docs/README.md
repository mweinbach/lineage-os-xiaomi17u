...
| [Camera property write capability](camera-property-vendor-init-write.md) | Committed one-grant correction preserves types, reads and assertions; paired host integration is verified, with source activation and native policy checks pending |
| [Factory property-prefix preservation](factory-property-contexts-capability.md) | Committed seven-row capability and paired 63-file host bundle preserve factory inputs; guest installation, Android M4 and final context/policy checks remain pending |
