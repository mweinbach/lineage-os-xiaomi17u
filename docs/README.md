...
| [Nothing10 profile failure and host-storage hold](build-progress.md#nothing10-profile-failure-and-host-storage-hold--2026-09-02) | Native exit 0 but profile exit 1 after six configuration changes; Nothing11 remains host-only and native work is held below the unchanged 100 GiB host reserve |
