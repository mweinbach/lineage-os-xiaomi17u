...
| [SystemUI Clock library correction](systemui-clocks-optional-window-libraries.md) | Selected-nine and Images3 builds/replays pass; Package3 fails later at the metadata checksum hook, with complete failure readback and a passing 14-case Toybox compatibility probe; source adoption and packaging retry remain pending |
...
| [Target-files metadata](target-files-metadata.md) | Exact 205-file projection and ordinary recipe hook; Package3 exposes unsupported Toybox `--strict`; 14 compatibility and 15 rendered-guard test cases pass, while additive 0023 and refreshed metadata/source composition remain unadopted |
