...
| [Explicit Evolution policy base](evolution-policy-base.md) | Inputs, patch 0015 and the minimal Soong visibility correction are installed; the original failure is preserved and native policy retry/context checks remain pending |
