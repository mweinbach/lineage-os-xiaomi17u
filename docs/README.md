...
| [BCR source integration](bcr-optional-window-libraries.md) | One-file 0021 source adoption, complete readback and independent review pass; the successor identity is host-projected, while native graph/status/module checks and package retry remain separate |
