...
| [Camera save and audio compatibility candidate](camera-save-audio-compat-20260908.md) | Source-stage checkpoint for the compressed DNG writer, neutral HDR repair and audio conversions; later verified v12 package below, phone validation pending |
| [Camera v12 package](camera-v12-package-20260908.md) | Compressed-DNG, neutral HDR and audio-conversion successor built, signed and verified; separate phone installation approval pending |
