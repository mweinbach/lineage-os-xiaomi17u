#!/usr/bin/env python3
"""Offline Make admission for the AICore global-firmware bundle.
...
def main() -> int:
    ...
    parser.add_argument("--contract", required=True, help="config/nezha-aicore.json")
