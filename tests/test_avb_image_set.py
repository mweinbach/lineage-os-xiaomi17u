...
class PublicProfileTests(NoNativeTests):
    ...
    def test_successor_system_ext_budget_is_measured_and_group_bounded(self):
        ...
        self.assertEqual([c["build_number"] for c in override["additional_measured_images"]],
                         ["nezha.f9e30611efe01b882f9ed0cb", "nezha.1088ec3b159be6c32e1403f2", "nezha.88dd30980cd24ea68d6b701e", "nezha.88dd30980cd24ea68d6b701e", "nezha.cc551b14bc2cc72c2b138bb0"])
